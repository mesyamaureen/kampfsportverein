Public Module Kampfsportverein
    ...
    Public Sub erzeugeBeispieldaten()
        ...
        sport1 = New Sportart("Judo", "Japan", "Zielgruppe weiß jetzt noch nicht", 10)
        sport2 = New Sportart("Karate", "Japan", "Zielgruppe weiß jetzt noch nicht", 12)
        sport3 = New Sportart("Muay Thai", "Thailand", "Zielgruppe weiß jetzt noch nicht", 10)
